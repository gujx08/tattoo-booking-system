...
const ConsultationChoice: React.FC = () => {
  ...
  const handleConsultationChoice = (needsConsultation: boolean) => {
    dispatch({ 
    ...
    if (needsConsultation) {
      dispatch({ type: 'SET_STEP', payload: 8 }); // Go to consultation scheduling
    } else {
      dispatch({ type: 'SET_STEP', payload: 9 }); // Skip to payment
    }
  };
